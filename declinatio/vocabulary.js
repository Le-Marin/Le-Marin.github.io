const VOCABULARY = [
  ...
  [
    ...
    ['e_ae', 'e_ārum', 'e_īs', 'e_ās', 'e_īs'],
  ],
  [
    6,
    'id n',
    'this, that / это, то',
    ['id', 'e_ius', 'e_ī', 'e_um', 'e_ō'],
    ['e_a', 'e_ōrum', 'e_īs', 'e_a', 'e_īs'],
  ],
  [
    6,
    'hic m',
    'this / этот',
    ['h_ic', 'h_uius', 'h_uī', 'h_unc', 'h_ōc'],
  ...
  [
    ...
    'aliud n',
    'other / другое',
    ['ali_um', 'alter_īus', 'ali_ī/ali_ō', 'ali_um', 'ali_ō'],
    ['ali_a', 'ali_ōrum', 'ali_īs', 'ali_a', 'ali_īs'],
  ],
  [
    6,
    'uter m',
    'which/either (of two) / который/какой-л. (из двух)',
  ...
  [
    6,
    'utra f',
    'which/either (of two) / которая/какая-л. (из двух)',
  ...
  [
    6,
    'utrum n',
    'which/either (of two) / которое/какое-л. (из двух)',
